...
//카카오페이 API서버에 요청하는 작업
/*
  - HttpURLConnection을 이용한 HTTP통신방법
  - RestTemplate을 이용한 통신방법(스프링 권장) https://minkwon4.tistory.com/178
...
public class KakaoPayServiceImpl {
	...
	private HttpHeaders getHeaderInfo() {
		...
		headers.set("Authorization", "KakaoAK 5060c23b6afd1d581e3e3a6ac682d44b");
	...
	public ReadyResponse payReady(Long odr_code, String itemName, int quantity, String mbsp_id, int totalAmount) {
		...
		parameters.add("item_name", itemName); // 상품명, 최대 100자 예> A상품 외 2건
