...
<script id="orderDetailTemplate" type="text/x-handlebars-template"></script>
</head>
<!--
BODY TAG OPTIONS:
=================
    		...
    		<div class="col-md-12">
    			<div class="box">
					...
					<div class="box-body">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td><span class="btn_order_detail" data-ord_code="${orderVO.ord_code }">${orderVO.ord_code }</span></td>								
								<td> 0 </td>
								<td> 0 </td>
								<td> 주문상태 </td>
					...
					<div class="box-footer clearfix">
						<div class="row">
							<div class="col-md-2">
								<button type="button" class="btn btn-primary" id="btn_check_modify1" role="button">체크상품 수정1</button>
								
								<button type="button" class="btn btn-primary" id="btn_check_modify2" role="button">체크상품 수정2</button>
							...
							<div class="col-md-2 text-right"> 
								<button type="button" class="btn btn-primary" role="button" id="btn_pro_insert">상품등록</button>
							</div>	
						</div>
