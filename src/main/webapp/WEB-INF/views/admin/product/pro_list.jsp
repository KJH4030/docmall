    		...
    		<div class="col-md-12">
    			<div class="box">
					...
					<div class="box-body">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td><button class="btn" value="수정">수정</button></td>
								<td><button class="btn btn-danger" value="삭제">삭제</button></td>
							</tr>
							</c:forEach>
							</tbody></table>
					</div>
					<div class="box-footer clearfix">
						<div class="row">
							<div class="col-md-2">
								<button type="button" class="btn btn-primary" id="btn_check_modify" role="button">체크상품 수정</button>
