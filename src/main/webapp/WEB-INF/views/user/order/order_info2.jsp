...
<body>
	...
	<div class="container">
		<table class="table table-striped">
			...
			<tfoot>
				<tr>
					<td colspan="12" style="text-align: right;"> 상품 총 <span id="cart_price_count">${fn:length(order_info) }</span>
					주문금액 : 
						...
						<div class="form-group row" id="nobank_info" style="display: none;">
							...
							<div class="col-10">
								...
								<select name="pay_nobank" id="pay_nobank">
									<option value="111-111-1111">KEB하나은행</option>
									<option value="222-222-2222">국민은행</option>										
									<option value="333-333-3333">신한은행</option>										
									<option value="444-444-4444">SC제일은행</option>										
								</select>
								계좌번호 <input type="text" id="pay_bankaccount" name="pay_bankaccount">  
								예금주 <input type="text" id="pay_nobank_user" name="pay_nobank_user">
								메모<textarea rows="3" cols="50" name="pay_memo" id="pay_memo"></textarea>
							</div>
						</div>	
					</fieldset>
			...
			if(paymethod === 'kakaopay'){
				...
				$.ajax({
					...
					data:{
						...
						pay_nobank : $("#pay_nobank option:selected").text(), //.val()은 value=""값 .text()는 국민은행
